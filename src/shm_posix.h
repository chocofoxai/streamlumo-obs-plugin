/**
 * StreamLumo POSIX Shared Memory Header
 * 
 * @license MIT
 */

#ifndef STREAMLUMO_SHM_POSIX_H
#define STREAMLUMO_SHM_POSIX_H
...
class ShmPosix {
public:
    ShmPosix(const std::string& channelName);
    ~ShmPosix();
